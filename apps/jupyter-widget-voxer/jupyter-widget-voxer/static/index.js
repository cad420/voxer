define(['@jupyter-widgets/base'], function (base) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var jupyterlab = {
    	extension: "dist/jupyterlab-plugin"
    };
    var data = {
    	name: name,
    	version: version,
    ...
    var ExampleModel = /** @class */ (function (_super) {
        ...
        ExampleModel.model_module = name$1;
        ExampleModel.model_module_version = version$1;
        ExampleModel.view_name = "ExampleView"; // Set to null if no view
        ExampleModel.view_module = name$1; // Set to null if no view
        ExampleModel.view_module_version = version$1;
        return ExampleModel;
    }(base.DOMWidgetModel));
