...
function TrackballControls(object, element) {
  ...
  this.dispose = function () {
    ...
    this.element.removeEventListener( 'mousedown', mousedown, false );
    this.element.removeEventListener( 'wheel', mousewheel, false );

    this.element.removeEventListener( 'touchstart', touchstart, false );
    this.element.removeEventListener( 'touchend', touchend, false );
    this.element.removeEventListener( 'touchmove', touchmove, false );
  ...
  this.element.addEventListener( 'wheel', mousewheel, false );

  this.element.addEventListener( 'touchstart', touchstart, false );
  this.element.addEventListener( 'touchend', touchend, false );
  this.element.addEventListener( 'touchmove', touchmove, false );
